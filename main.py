...
Usage: python main.py (from project root directory)

History is automatically persisted by LangGraph Checkpointer; main.py does not need to manage it manually.
"""
...
def _init_thread(config: dict, user_id: str, force_reset: bool = False) -> None:
    ...
    if force_reset or not has_state:
        ...
        # Resume existing session: refresh user_profile only
