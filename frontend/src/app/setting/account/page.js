...
export default function AccountPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-cream">
      <TopBar title="Account" transparent />
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-6">
        ...
        <div className="flex flex-col items-center mt-2 mb-6">
          ...
          <p className="text-xs text-gray-400 mt-1.5">Tap to change avatar</p>
        </div>
        ...
        {showAvatarPicker && (
          <>
            ...
            <div className="fixed top-1/3 left-8 right-8 bg-white rounded-2xl z-50 p-5 shadow-xl">
              <h4 className="text-base font-bold mb-4 text-gray-800">Choose Avatar</h4>
        ...
        <div className="mb-5">
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="text-xs text-gray-500">Birth Year</label>
              <input
                type="number"
