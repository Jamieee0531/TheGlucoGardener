...
const dict = {
  ...
  nav_warmup: { English: "Warm Up", Chinese: "每日热身", Malay: "Pemanasan", Tamil: "வார்ம் அப்" },
  nav_demo: { English: "Demo Console", Chinese: "演示控制台", Malay: "Konsol Demo", Tamil: "டெமோ கன்சோல்" },
  nav_task_demo: { English: "Task Publish Demo", Chinese: "运动任务演示", Malay: "Demo Tugasan", Tamil: "பணி டெமோ" },
  ...
  task_sunset_desc: { English: "Personalised quest: Take a brisk walk at a nearby park and enjoy the greenery.", Chinese: "个性化任务：去附近的公园快走，享受绿意。", Malay: "Cabaran peribadi: Berjalan pantas di taman berdekatan dan nikmati kehijauan.", Tamil: "தனிப்பயன் சவால்: அருகிலுள்ள பூங்காவில் வேகமாக நடந்து பசுமையை அனுபவியுங்கள்." },
  ...
  task_quest_today: { English: "Your quest for today", Chinese: "今日专属任务", Malay: "Misi anda hari ini", Tamil: "இன்றைய உங்கள் சவால்" },
  task_quest_complete: { English: "Quest Complete!", Chinese: "任务完成！", Malay: "Misi Selesai!", Tamil: "சவால் நிறைவு!" },
  task_quest_locked: { English: "Your personalised quest will appear once today's activity triggers the system", Chinese: "当今日活动触发系统后，您的专属任务将会出现", Malay: "Misi peribadi anda akan muncul selepas aktiviti hari ini mencetuskan sistem", Tamil: "இன்றைய செயல்பாடு அமைப்பைத் தூண்டியவுடன் உங்கள் தனிப்பயன் சவால் தோன்றும்" },
  task_quest_personalising: { English: "Personalising your quest...", Chinese: "正在为您定制任务...", Malay: "Memperibadikan misi anda...", Tamil: "உங்கள் சவாலைத் தனிப்பயனாக்குகிறது..." },
  task_log_proof: { English: "Log Proof", Chinese: "上传证明", Malay: "Log Bukti", Tamil: "ஆதாரம் பதிவு" },
  task_logging: { English: "Logging...", Chinese: "记录中...", Malay: "Merekod...", Tamil: "பதிவு செய்கிறது..." },
  ...
  message_board: { English: "Messages", Chinese: "留言板", Malay: "Mesej", Tamil: "செய்திகள்" },
  flowers: { English: "flowers", Chinese: "朵花", Malay: "bunga", Tamil: "மலர்கள்" },
  ...
  soft_alert_msg: {
    English: "Your blood sugar is on the low side at 4.9 — and it could drop by about 1.03 during your HIIT session, putting you around 3.87 by mid-workout. Maybe grab a couple of cream crackers with cheese or a small banana before you start. You've got this!",
    Chinese: "你的血糖目前偏低，在 4.9。HIIT 训练期间可能会再降 1.03 左右，运动中段可能降到 3.87。建议先吃两片芝士苏打饼或一根小香蕉再开始。加油！",
    Malay: "Gula darah anda agak rendah pada 4.9 — dan ia boleh turun kira-kira 1.03 semasa sesi HIIT anda, menjadi sekitar 3.87 di tengah senaman. Cuba ambil beberapa keping biskut krim dengan keju atau sebiji pisang kecil sebelum mula. Anda boleh!",
    Tamil: "உங்கள் இரத்த சர்க்கரை 4.9 என்று சற்று குறைவாக உள்ளது — HIIT பயிற்சியின் போது 1.03 அளவு குறையலாம், 3.87 ஆக இருக்கலாம். தொடங்கும் முன் கிரீம் கிராக்கர்ஸ் + சீஸ் அல்லது சிறிய வாழைப்பழம் சாப்பிடுங்கள்.",
  },
  ...
  soft_alert_demo_reasoning: {
    English: "Current glucose is 4.9 mmol/L — in the pre-exercise buffer zone but on the low side for HIIT. Based on your last 3 HIIT sessions, average glucose drop was 1.03 mmol/L, projecting to ~3.87 mmol/L mid-workout (below the 3.9 safety line). You've only had 670 kcal today (Kaya Toast at 06:30 and Chicken Sandwich at 11:30) — glycogen reserves are likely low. Cream crackers with cheese (~15g slow-release carbs) or a small banana (~23g) recommended before starting.",
    Chinese: "当前血糖 4.9 mmol/L — 处于运动前缓冲区但对 HIIT 偏低。根据最近 3 次 HIIT 记录，平均血糖下降 1.03 mmol/L，预测运动中降至约 3.87 mmol/L（低于 3.9 安全线）。今天仅摄入 670 大卡（06:30 咖椰吐司和 11:30 鸡肉三明治）— 糖原储备可能不足。建议运动前吃芝士苏打饼（约 15g 缓释碳水）或一根小香蕉（约 23g）。",
    Malay: "Glukosa semasa 4.9 mmol/L — dalam zon penimbal pra-senaman tetapi agak rendah untuk HIIT. Berdasarkan 3 sesi HIIT terakhir, purata penurunan glukosa ialah 1.03 mmol/L, diunjurkan ~3.87 mmol/L semasa senaman (bawah garisan keselamatan 3.9). Anda hanya mengambil 670 kcal hari ini (Kaya Toast 06:30 dan Chicken Sandwich 11:30). Biskut krim dengan keju (~15g) atau sebiji pisang kecil (~23g) disyorkan.",
    Tamil: "தற்போதைய குளுக்கோஸ் 4.9 mmol/L — HIIT-க்கு சற்று குறைவு. கடைசி 3 HIIT அமர்வுகளின் அடிப்படையில், சராசரி 1.03 mmol/L குறைந்து ~3.87 mmol/L ஆக கணிக்கப்படுகிறது (3.9 பாதுகாப்பு எல்லைக்கு கீழே). இன்று 670 kcal மட்டுமே (காயா டோஸ்ட் 06:30, சிக்கன் சாண்ட்விச் 11:30). கிரீம் கிராக்கர்ஸ் + சீஸ் (~15g) அல்லது சிறிய வாழைப்பழம் (~23g) பரிந்துரைக்கப்படுகிறது.",
  },
